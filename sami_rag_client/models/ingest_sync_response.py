...
class IngestSyncResponse(BaseModel):
    ...
    IngestSyncResponse
    """ # noqa: E501
    source_adapter: StrictStr
    synced_count: StrictInt
    accepted: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["source_adapter", "synced_count", "accepted", "quarantined", "rejected", "accepted_doc_ids", "quarantined_doc_ids", "rejected_doc_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "synced_count": obj.get("synced_count"),
