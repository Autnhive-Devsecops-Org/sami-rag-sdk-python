...
class FileUrlIngestRequest(BaseModel):
    ...
    doc_id: Optional[StrictStr] = Field(default=None, description="Optional public document identifier. If omitted, a stable ID is derived from the file URL.")
    file_url: StrictStr
    metadata: Optional[Dict[str, Any]] = None
    store_quarantine: Optional[StrictBool] = True
    retriever_backend: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["tenant_id", "app_id", "doc_id", "file_url", "metadata", "store_quarantine", "retriever_backend"]
