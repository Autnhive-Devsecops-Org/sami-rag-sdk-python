...
class ORCHESTRATORApi:
    ...
    def rag_query(
        ...
        :param rag_query_request: (required)
        :type rag_query_request: RagQueryRequest
        :param authorization:
        ...
        _param = self._rag_query_serialize(
    ...
    @validate_call
    def rag_query_without_preload_content(
        self,
        rag_query_request: RagQueryRequest,
        authorization: Optional[StrictStr] = None,
        x_request_id: Optional[StrictStr] = None,
    ...
    def _rag_query_serialize(
        ...
        if rag_query_request is not None:
            _body_params = rag_query_request
