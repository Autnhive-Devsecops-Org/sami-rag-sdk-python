...
with sami_rag_client.ApiClient(configuration) as api_client:
    ...
    api_instance = sami_rag_client.ChatApi(api_client)
    chat_completion_request = sami_rag_client.ChatCompletionRequest() # ChatCompletionRequest | 
