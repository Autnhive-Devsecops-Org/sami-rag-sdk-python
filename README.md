...
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/Autnhive-Devsecops-Org/sami-rag-sdk-python.git`)
...
## Documentation For Models
 ...
 - [FileUrlIngestRequest](docs/FileUrlIngestRequest.md)
